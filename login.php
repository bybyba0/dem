...
<section class="auth-wrap">
  <div class="container auth-grid">
    <div class="auth-aside reveal">
      ...
      <p>Войдите, чтобы оформить заявку, посмотреть историю и оставить отзыв.</p>
      <ul class="auth-list">
        <li>✓ Личный кабинет с историей заявок</li>
        <li>✓ Статусы мероприятий в реальном времени</li>
