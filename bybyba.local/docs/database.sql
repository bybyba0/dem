-- ============================================================
--  Схема базы данных портала «Конференции.РФ»
...
CREATE TABLE items (
    id          INT AUTO_INCREMENT PRIMARY KEY,
    category    VARCHAR(60)  NOT NULL,                -- Аудитория / Коворкинг / Кинозал
...
CREATE TABLE requests (
    ...
    status      VARCHAR(60) NOT NULL,                 -- Новая / Мероприятие назначено / Мероприятие завершено
    created_at  TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
